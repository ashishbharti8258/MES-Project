...
ISEStep( "vivado",
         "-log ecg_system_axi_mem_intercon_imp_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ecg_system_axi_mem_intercon_imp_xbar_0.tcl" );
