...
HD_PWD='C:/Users/Rohit Kumawat/ecg_fpga_system/ecg_fpga_system.runs/ecg_system_axi_mem_intercon_imp_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ecg_system_axi_mem_intercon_imp_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ecg_system_axi_mem_intercon_imp_xbar_0.tcl
