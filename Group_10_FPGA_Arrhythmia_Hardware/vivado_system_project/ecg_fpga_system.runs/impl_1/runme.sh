...
HD_PWD='C:/Users/Rohit Kumawat/ecg_fpga_system/ecg_fpga_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ecg_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ecg_system_wrapper.tcl -notrace
