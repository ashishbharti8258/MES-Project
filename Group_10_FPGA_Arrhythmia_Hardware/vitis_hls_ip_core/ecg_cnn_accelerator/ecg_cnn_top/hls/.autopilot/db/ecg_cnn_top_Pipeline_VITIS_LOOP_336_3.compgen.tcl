...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ecg_cnn_top_sparsemux_9_3_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_mx_out \
    op interface \
    ports { mx_out { O 32 vector } mx_out_ap_vld { O 1 bit } } \
} "
}
