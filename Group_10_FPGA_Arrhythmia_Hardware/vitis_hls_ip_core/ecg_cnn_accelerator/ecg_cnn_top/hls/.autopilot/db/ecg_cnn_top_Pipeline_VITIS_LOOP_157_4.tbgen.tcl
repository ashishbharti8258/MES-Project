set moduleName ecg_cnn_top_Pipeline_VITIS_LOOP_157_4
set isTopModule 0
...
set cdfgNum 23
set C_modelName {ecg_cnn_top_Pipeline_VITIS_LOOP_157_4}
...
set C_modelArgList {
	{ acc_11 float 32 regular  }
	{ zext_ln160 int 7 regular  }
	{ zext_ln152 int 4 regular  }
	{ zext_ln159 int 11 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "acc_11", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln160", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln152", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln159", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ acc_11 sc_in sc_lv 32 signal 0 } 
	{ zext_ln160 sc_in sc_lv 7 signal 1 } 
	{ zext_ln152 sc_in sc_lv 4 signal 2 } 
	{ zext_ln159 sc_in sc_lv 11 signal 3 } 
	{ acc_16_out sc_out sc_lv 32 signal 4 } 
	{ acc_16_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "acc_11", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_11", "role": "default" }} , 
 	{ "name": "zext_ln160", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln160", "role": "default" }} , 
 	{ "name": "zext_ln152", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln152", "role": "default" }} , 
 	{ "name": "zext_ln159", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "zext_ln159", "role": "default" }} , 
...
set Spec2ImplPortList { 
	acc_11 { ap_none {  { acc_11 in_data 0 32 } } }
	zext_ln160 { ap_none {  { zext_ln160 in_data 0 7 } } }
	zext_ln152 { ap_none {  { zext_ln152 in_data 0 4 } } }
	zext_ln159 { ap_none {  { zext_ln159 in_data 0 11 } } }
