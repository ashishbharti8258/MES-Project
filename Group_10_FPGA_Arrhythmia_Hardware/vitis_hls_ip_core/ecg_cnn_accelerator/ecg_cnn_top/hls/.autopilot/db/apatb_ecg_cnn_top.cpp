...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.ecg_cnn_top.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.ecg_cnn_top.autotvout_input_r.dat"
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.ecg_cnn_top.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.ecg_cnn_top.autotvout_output_r.dat"
#define AUTOTB_TVIN_INPUT_BUS "../tv/cdatafile/c.ecg_cnn_top.autotvin_INPUT_BUS.dat"
#define AUTOTB_TVOUT_INPUT_BUS "../tv/cdatafile/c.ecg_cnn_top.autotvout_INPUT_BUS.dat"
#define AUTOTB_TVIN_OUTPUT_BUS "../tv/cdatafile/c.ecg_cnn_top.autotvin_OUTPUT_BUS.dat"
#define AUTOTB_TVOUT_OUTPUT_BUS "../tv/cdatafile/c.ecg_cnn_top.autotvout_OUTPUT_BUS.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_INPUT_BUS "../tv/rtldatafile/rtl.ecg_cnn_top.autotvout_INPUT_BUS.dat"
#define AUTOTB_TVOUT_PC_OUTPUT_BUS "../tv/rtldatafile/rtl.ecg_cnn_top.autotvout_OUTPUT_BUS.dat"
...
extern "C"
void ecg_cnn_top_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_ecg_cnn_top_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_INPUT_BUS),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_INPUT_BUS),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_OUTPUT_BUS),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_OUTPUT_BUS),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_OUTPUT_BUS),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_OUTPUT_BUS),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_OUTPUT_BUS),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_OUTPUT_BUS),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  ...
  try {
    ...
    ecg_cnn_top_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
