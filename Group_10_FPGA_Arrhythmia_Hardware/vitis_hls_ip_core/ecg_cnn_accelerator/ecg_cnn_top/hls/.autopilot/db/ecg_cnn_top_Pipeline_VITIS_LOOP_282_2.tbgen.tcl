set moduleName ecg_cnn_top_Pipeline_VITIS_LOOP_282_2
set isTopModule 0
...
set cdfgNum 23
set C_modelName {ecg_cnn_top_Pipeline_VITIS_LOOP_282_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict s4_out { MEM_WIDTH 32 MEM_SIZE 2816 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ zext_ln280 int 6 regular  }
	{ s_out float 32 regular {pointer 1}  }
	{ s4_out float 32 regular {array 704 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln280", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "s_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "s4_out", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ zext_ln280 sc_in sc_lv 6 signal 0 } 
	{ s_out sc_out sc_lv 32 signal 1 } 
	{ s_out_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ s4_out_address0 sc_out sc_lv 10 signal 2 } 
	{ s4_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ s4_out_q0 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln280", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln280", "role": "default" }} , 
 	...
 	{ "name": "s4_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "s4_out", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	zext_ln280 { ap_none {  { zext_ln280 in_data 0 6 } } }
	s_out { ap_vld {  { s_out out_data 1 32 }  { s_out_ap_vld out_vld 1 1 } } }
	s4_out { ap_memory {  { s4_out_address0 mem_address 1 10 }  { s4_out_ce0 mem_ce 1 1 }  { s4_out_q0 mem_dout 0 32 } } }
}
